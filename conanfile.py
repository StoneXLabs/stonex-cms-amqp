...
class StonexCMSAMQPLib(ConanFile):
    ...
    build_requires = ["red-hat-amq-clients-c++/2.10.4@enterprise_messaging/test","jsoncpp/1.9.5@enterprise_messaging/test","gtest/1.10.0","boost/1.78.0@enterprise_messaging/stable"]
    generators = "cmake"
